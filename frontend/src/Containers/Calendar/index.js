...
const Calendar = props => {
  ...
  const getTeamMembers = () => {
    ...
    // console.log("items", moment(date).format("hh:mm"));
  ...
  return (
    <>
      ...
      <div className="content">
        ...
        <Modal size="xl" isOpen={teamModal} toggle={teamModalData}>
          <ModalHeader style={{ borderBottom: 0 }}>
            <button
              aria-hidden={true}
              className="close"
          ...
          <ModalBody>
            <Row>
              <Col md="12">
                <Card>
                  <CardBody style={{ borderTopStyle: "outset" }}>
                    <div>
                      <Table responsive="lg">
                        <thead>
                        ...
                        <tbody className="container-drag">
                          {teamData.length ? (
                            teamData.map((item, index) => (
                              <tr key={index} style={styles.borderBottom}>
                                <td
                                  className="text-center "
